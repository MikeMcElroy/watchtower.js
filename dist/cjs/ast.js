...
var WatchRecord = require('./change_detection').WatchRecord;
var $__1 = require('./watch_record'),
...
var FieldReadAST = function FieldReadAST(lhs, name) {
  this.lhs = lhs;
  this.name = name;
  $traceurRuntime.superCall(this, $FieldReadAST.prototype, "constructor", [this.lhs + '.' + this.name]);
};
